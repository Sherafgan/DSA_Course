...
/**
 * Created by Bane Dite on 28.09.2015.
 */
public class Timsort<T> {

    private static int counterOfIterates = 0;

    public static void setCounterOfIterates(int counterOfIterates) {
        Timsort.counterOfIterates = counterOfIterates;
    }

    public static int getCounterOfIterates() {
        return counterOfIterates;
    }
    ...
    Timsort(T[] a, Comparator<? super T> c) {
        this.a = a;
        this.c = c;
