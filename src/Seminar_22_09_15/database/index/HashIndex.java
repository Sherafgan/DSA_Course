package Seminar_22_09_15.database.index;

import java.util.*;
import Seminar_22_09_15.database.*;
import Seminar_22_09_15.database.MyFramework.MyMap;
...
public class HashIndex extends Index {
	...
	private Integer getHash(Comparable val) {
		if (val instanceof String)
			return Seminar_22_09_15.database.MyFramework.hash((String)val);
		else if (val instanceof Float)
			return Seminar_22_09_15.database.MyFramework.hash((Float)val);
		return val.hashCode();
	}
